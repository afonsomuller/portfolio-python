# Esse foi o segundo projeto da matéria de Raciocínio algorírmico, desenvolvido em conjunto com outros 2 alunos.
# O Objetivo do projeto era a implementação de um sistema de aluguel de bicicletas, com verificaçao de usuário e senha,
# Verificação de créditos, listagem de bicicletas alugadas, com data a hora das locações e o número de locações.
...
def devolver_bicicleta(creditos, locacao):
    if verificar_bicicleta_alugada(locacao):
        ...
        creditos, locacao = atualizar_locacao_e_creditos(locacao, escolha, data_devolucao, hora_devolucao, creditos, horas_alugadas)
    else:
