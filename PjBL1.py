# Esse foi o primeiro projeto que implementei com python. O sistema consiste em um sistema de cartões de transporte publico.
# Conta com verificação de senha, créditos suficientes para utilizar o cartão, recarga e um menu separado para administrador.
# Desenvolvido para a matéria de Raciocínio Algotítmico, com a participação e auxilio de outros 3 alunos do curso.
